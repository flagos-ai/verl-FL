...
# TE-FL see https://github.com/flagos-ai/TransformerEngine-FL/pull/4
...
# training engine, such as FSDP, Megatron, when using discrete process from rollout
# export TRAINING_FL_PREFER=flagos	#flagos / vendor / reference	flagos
# TRAINING_FL_FLAGOS_WHITELIST
# TRAINING_FL_FLAGOS_BLACKLIST

# Rollout phase environment variables, see https://github.com/flagos-ai/vllm-plugin-FL/blob/main/vllm_fl/dispatch/README.md#environment-variables
...
# export VLLM_FL_FLAGOS_BLACKLIST
